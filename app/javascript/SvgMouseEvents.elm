...
-}
onMouseEnter : (MouseEvent -> msg) -> Svg.Attribute msg
onMouseEnter target =
...
<https://developer.mozilla.org/en-US/docs/Web/Events> for details.
-}
onMouseMove : (MouseEvent -> msg) -> Svg.Attribute msg
onMouseMove target =
...
<https://developer.mozilla.org/en-US/docs/Web/Events> for details.
-}
onMouseDown : (MouseEvent -> msg) -> Svg.Attribute msg
onMouseDown target =
...
<https://developer.mozilla.org/en-US/docs/Web/Events> for details.
-}
onMouseUp : (MouseEvent -> msg) -> Svg.Attribute msg
onMouseUp target =
...
<https://developer.mozilla.org/en-US/docs/Web/Events> for details.
-}
onClick : (MouseEvent -> msg) -> Svg.Attribute msg
onClick target =
...
<https://developer.mozilla.org/en-US/docs/Web/Events> for details.
-}
onDoubleClick : (MouseEvent -> msg) -> Svg.Attribute msg
...
<https://developer.mozilla.org/en-US/docs/Web/Events> for details.
-}
onContextMenu : (MouseEvent -> msg) -> Svg.Attribute msg
...
<https://developer.mozilla.org/en-US/docs/Web/Events> for details.
-}
onWheel : (MouseEvent -> msg) -> Svg.Attribute msg
onWheel target =
...
<https://developer.mozilla.org/en-US/docs/Web/Events> for details.
-}
onMouseLeave : (MouseEvent -> msg) -> Svg.Attribute msg
onMouseLeave target =
...
<https://developer.mozilla.org/en-US/docs/Web/Events> for details.
-}
onMouseOut : (MouseEvent -> msg) -> Svg.Attribute msg
onMouseOut target =
...
<https://developer.mozilla.org/en-US/docs/Web/Events> for details.
-}
onSelect : (MouseEvent -> msg) -> Svg.Attribute msg
onSelect target =
...
<https://developer.mozilla.org/en-US/docs/Web/Events> for details.
-}
onPointerLockChange : (MouseEvent -> msg) -> Svg.Attribute msg
...
<https://developer.mozilla.org/en-US/docs/Web/Events> for details.
-}
onPointerLockError : (MouseEvent -> msg) -> Svg.Attribute msg
