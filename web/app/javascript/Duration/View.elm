...
import Html.Attributes exposing (attribute, id, style, placeholder)
import UI.Input
import UI.Label
import UI.Layout exposing (compactColumn, row)


input : (( String, String, String ) -> msg) -> ( String, String, String ) -> ( String, String, String ) -> Html msg
input msg ( hrs, mins, secs ) ( pHrs, pMins, pSecs ) =
    row []
